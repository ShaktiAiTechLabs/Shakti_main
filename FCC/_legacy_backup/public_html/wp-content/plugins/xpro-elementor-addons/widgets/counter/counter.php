...
class Counter extends Widget_Base {
	...
	protected function register_controls() {
		...
		$this->add_control(
			'title_tag',
			array(
				'label'     => __( 'Title HTML Tag', 'xpro-elementor-addons-pro' ),
				'type'      => Controls_Manager::SELECT,
				'options'   => array(
					'h1'   => __( 'H1', 'xpro-elementor-addons-pro' ),
					'h2'   => __( 'H2', 'xpro-elementor-addons-pro' ),
					'h3'   => __( 'H3', 'xpro-elementor-addons-pro' ),
					'h4'   => __( 'H4', 'xpro-elementor-addons-pro' ),
					'h5'   => __( 'H5', 'xpro-elementor-addons-pro' ),
					'h6'   => __( 'H6', 'xpro-elementor-addons-pro' ),
					'div'  => __( 'Div', 'xpro-elementor-addons-pro' ),
					'span' => __( 'Span', 'xpro-elementor-addons-pro' ),
					'p'    => __( 'P', 'xpro-elementor-addons-pro' ),
				),
				'default'   => 'h3',
			)
		);
